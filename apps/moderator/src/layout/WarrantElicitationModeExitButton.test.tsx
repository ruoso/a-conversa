...
describe('WarrantElicitationModeExitButton — render gating', () => {
  ...
  it('renders the button + overlay when mode is warrant-elicitation and a matching node-created event exists', () => {
    useWsStore
      .getState()
...
describe('WarrantElicitationModeExitButton — exit gestures', () => {
  it('clicking the button calls exitWarrantElicitationMode and unmounts the button', () => {
    useWsStore
      .getState()
  ...
  it('Escape keypress fires exitWarrantElicitationMode while mode is warrant-elicitation', () => {
    useWsStore
      .getState()
      .applyEvent(makeNodeCreated({ sequence: 1, nodeId: NODE_A, wording: 'w' }));
    act(() => {
