// Moderator-surface i18next bootstrap.
//
...
//
// Initializes a single shared `i18next` instance for the moderator
// console using the canonical config from `@a-conversa/i18n-catalogs`.
// The locale parameter is resolved upstream by
// `frontend_i18n.i18n_locale_negotiation` (browser-detector +
// `aconversa_locale` cookie on the moderator surface); this module
...
//
// `mod_app_skeleton` calls `initI18n(locale)` from its `main.tsx`
