...
//   (the applyDiagnostic active-set cases + the "fresh session carries an
//   empty activeDiagnostics map" case have collapsed into
//   `packages/shell/src/ws/ws-client.test.ts` after the slot's
//   shell-canonicalization; only the four audience-local wrapper shape
//   cases stay here.)
//
