...
### 2026-06-10 — i18n native review — landing.demo.chatLabel + landing.demo.dialogue.* (pt-BR, es-419)

- **Source**: closer for `landing_page.walkthrough_dialogue_chat` (refinement Acceptance §i18n discipline).
